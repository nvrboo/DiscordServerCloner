...
class ServerCloner:
    ...
    def clone(self):
        ...
        async def on_ready():
            ...
            # self.guild_data = await self.get_guild_data(self.original_guild)
    ...
    async def edit_guild_icon(self, retries: int = 0):
    ...
    async def clean_emojis(self):
        ...
        for emoji in self.new_guild.emojis:
            ...
            await asyncio.sleep(self.copy_interval * 2)
